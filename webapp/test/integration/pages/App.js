sap.ui.require(
    ...
    function(Opa5, Common, PropertyStrictEquals, Press) {
        ...
        var sViewName = 'ui5.futureview.view.App';
                    ...
                    iSeeTheGivenTextOfTheInputField: function() {
                        return this.waitFor({
                            ...
                            success: function() {
                                Opa5.assert.ok(
                                    true,
                                    "The text 'Here comes the text...' is shown in the input field"
                                );
                            },
                    ...
                    iSeeTheExpectedTextOfTheInputField: function() {
                        return this.waitFor({
                            ...
                            success: function() {
                                Opa5.assert.ok(
                                    true,
                                    "The text in the inputfield is changed to 'Hello World!'"
                                );
                            },
                            errorMessage:
                                "The text in the inputfield is not changed to 'Hello World!",
                        });
                    },
